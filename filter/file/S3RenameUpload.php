...
namespace jambroo\aws\filter\file;

use Yii;
use yii\base\Behavior;

use Aws\S3\S3Client;
use jambroo\aws\filter\exception\MissingBucketException;
...
class S3RenameUpload extends Behavior
{
     ...
     */
    public function __construct(S3Client $client, $targetOrOptions = array())
    {
